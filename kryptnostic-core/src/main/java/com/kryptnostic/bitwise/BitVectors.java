...
public final class BitVectors {
     ...
     * 
     * @param bits the total number of bits in the resultant bit vector. There must be enough byte supplied 
     * to create the bitvector, i.e {@code (bytes.length * 8) > bits}.
     ...
     * @return Returns the bits from lhs as the lower order bits, followed by the bits from rhs as the higher order bits.
     */
     ...
     * Concatenates, in order, an array of BitVectors. 
     * @param vectors The vectors to concatenate.
     * @return The vectors concatenated, in order, i.e {@code {vectors.get(0),vectors.get(1),...,vectors.get(vectors.size()-1)}}
     */
