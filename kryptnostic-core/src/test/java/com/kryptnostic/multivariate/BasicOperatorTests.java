...
public class BasicOperatorTests {
    ...
    @Test
    public void testXor() {
        SimplePolynomialFunction xor = SimplePolynomialOperators.XOR(256);
        ...
        long[] expected = new long[] { values[0] ^ values[2], values[1] ^ values[3], 0L, 0L };
    ...
    public void testBinaryXor() {
        SimplePolynomialFunction xor = SimplePolynomialOperators.BINARY_XOR(128);
        Assert.assertEquals(256, xor.getInputLength());
        ...
        long[] expected = new long[] { values[0] ^ values[2], values[1] ^ values[3] };

        BitVector result = xor.apply(new BitVector(values, 256));
        BitVector result2 = xor.apply(new BitVector(Arrays.copyOfRange(values, 0, 2), 128),
                new BitVector(Arrays.copyOfRange(values, 2, 4), 128));
    ...
    @Test
    public void testAnd() {
        SimplePolynomialFunction and = SimplePolynomialOperators.AND(256);
    ...
    public void testBinaryAnd() {
        SimplePolynomialFunction and = SimplePolynomialOperators.BINARY_AND(128);
        Assert.assertEquals(256, and.getInputLength());
        ...
        BitVector result = and.apply(new BitVector(values, 256));
        BitVector result2 = and.apply(new BitVector(Arrays.copyOfRange(values, 0, 2), 128),
                new BitVector(Arrays.copyOfRange(values, 2, 4), 128));
        Assert.assertEquals(128, result.size());
        Assert.assertEquals(128, result2.size());
        Assert.assertArrayEquals(expected, result.elements());
    ...
    @Test
    public void testNEG() {
        SimplePolynomialFunction neg = SimplePolynomialOperators.NEG(128);
    ...
    @Test
    public void testLSH() {
        SimplePolynomialFunction lsh = SimplePolynomialOperators.LSH(128, 23);
        BitVector v = BitVectors.randomVector(128);
    ...
    @Test
    public void testRSH() {
        SimplePolynomialFunction rsh = SimplePolynomialOperators.RSH(128, 23);
        BitVector v = BitVectors.randomVector(128);
    ...
    public void testADDER() {
        ...
        PolynomialFunction adder = SimplePolynomialOperators.ADDER(64);
