...
public interface SimplePolynomialFunction extends PolynomialFunction {
     ...
     * @return A new function representing the function composition of this function and inner, such that evaluating it
     *         on input is equivalent to {@code this.evaluate( inner.evaluate( input ) )}
     */
    @Timed
    ...
    /**
     * 
     * @return a new function that represents the partial composition of this function and inner, such that evaluating
     *         it is equivalent to {@code this.evaluate( inner.evaluate( lhs ), rhs )}
     */
    @Timed
